...
namespace InventoryTracker
{
    public partial class Form1 : Form
    {
        ...
        private void restockButton_Click(object sender, EventArgs e)
        {
            ...
            Restock_Item restockForm = new Restock_Item(this, (InventoryItemEntry)itemsListBox.SelectedItem);
        ...
        {
            List<InventoryItemEntry> listToSave = InventoryManager.GetItems();

            StreamWriter outputList;
            outputList = File.CreateText("InventoryManager.txt");

            for(int i = 0; i < listToSave.Count; i++)
            {
                outputList.WriteLine(listToSave[i]);
            }
            outputList.Close();

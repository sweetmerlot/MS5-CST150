...
namespace InventoryTracker
{
    public partial class NewItemForm : Form
    {
        ...
        public void addItemButton_Click(object sender, EventArgs e)
        {
            ...
            string itemPrice = newItemPrice.Text;
            decimal tryDecimal;

            if(decimal.TryParse(itemPrice, out tryDecimal))
            {
                
                int itemCategory = (int)newItemCategory.SelectedItem;
                

                InventoryItem item = new InventoryItem(itemName, itemSku, itemDescription, tryDecimal, itemCategory);
            ...
            {
                MessageBox.Show("Enter Price in Correct Format 00.00");
            }
